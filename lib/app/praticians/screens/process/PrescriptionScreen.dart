...
class PrescriptionScreen extends StatefulWidget {
  ...
  const PrescriptionScreen(this.idDemande, this.patient, this.praticien,
      {Key? key})
      : super(key: key);
...
class _PrescriptionScreenState extends State<PrescriptionScreen> {
                  ...
                  pw.Expanded(
                    child: pw.Column(
                      ...
                      children: [
                        ...
                        pw.Text(
                          praticienNumer == null ? "" : "$praticienNumer",
  ...
  Future savePdf() async {
    ...
    File file = File("$dir/ORD${DateTime.now().toString()}" + ".pdf");

    file.writeAsBytesSync(bytes, flush: true);

//  showFile(context, file.path);
    String nomDocument = 'ORDONNANCE';
  ...
  void sendMessage() async {
    await _db
        ...
        .add({
      'text':
          "Une ordonnance vous a été prescrite, vérifiez votre dossier médical",
        ...
        child: Column(
          children: [
            TextField(
              ...
              decoration:
                  InputDecoration(hintText: "Médicaments, séringue ..."),
